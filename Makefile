...
$(REMOVAL_MODEL) : $(REMOVAL_DATA_DIR) $(VOCAB_FILE) $(REMOVAL_TRAINING_CONFIG)
	...
	accelerate launch steps/run_task.py $(REMOVAL_TRAINING_CONFIG)
...
$(GENERATION_MODEL) : $(GENERATION_DATA_DIR) $(GENERATION_TRAINING_CONFIG)
	...
	accelerate launch steps/run_task.py $(GENERATION_TRAINING_CONFIG)
...
$(REV_MODEL) : $(REV_DATA_DIR) $(REV_TRAINING_CONFIG)
	...
	accelerate launch steps/run_task.py $(REV_TRAINING_CONFIG)
...
$(BASELINE_MODEL) : $(BASELINE_DATA_DIR) $(BASELINE_TRAINING_CONFIG)
	...
	accelerate launch steps/run_task.py $(BASELINE_TRAINING_CONFIG)
...
$(RVB_MODEL) : $(RVB_DATA_DIR) $(RVB_TRAINING_CONFIG)
	...
	accelerate launch steps/run_task.py $(RVB_TRAINING_CONFIG)
...
$(RVR_MODEL) : $(RVR_DATA_DIR) $(RVR_TRAINING_CONFIG)
	...
	accelerate launch steps/run_task.py $(RVR_TRAINING_CONFIG)
